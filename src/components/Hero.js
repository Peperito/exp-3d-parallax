...
export const Hero = () => {
    ...
    return (
        <div className="flex xl:flex-row flex-col justify-start ">
            ...
            <div className="flex flex-row flex-wrap xl:my-24 mx-10 p-6 bg-white bg-opacity-20 rounded-md shadow-md max-w-md">
                <img src={redisimg} alt="redis" className="h-24 w-24 mx-4 mt-4" />
                <img src={PostgresImg} alt="postgres" className="h-20 w-20 mx-4 mt-4" />
                <img src={nodeimg} alt="node" className="h-24 w-24 mx-4" />
                <img src={reactimg} alt="react" className="h-20 w-20 mx-4" />
                <img src={tailwindimg} alt="tailwind" className="h-20 w-20 mx-4" />
                <img src={typescriptimg} alt="ts" className="h-20 w-28 mx-4" />
            </div>
            </motion.div>
        </div>
    )
