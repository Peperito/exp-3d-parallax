        ...
        <div className="flex xl:flex-row flex-col justify-start ">
            ...
            <div className="flex flex-row flex-wrap xl:my-24 mx-12 mr-14 p-6 bg-white bg-opacity-20 rounded-md shadow-md max-w-sm">
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={redisimg} alt="redis" className="h-12 w-12 xl:h-20 xl:w-20 mx-2 " /> 
                </button>
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={PostgresImg} alt="postgres" className="h-12 w-12 xl:h-20 xl:w-20 mx-4 mt-4" /> 
                </button>
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={nodeimg} alt="node" className="h-12 w-12 xl:h-20 xl:w-20 mx-2" /> 
                </button>
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={reactimg} alt="react" className="h-12 w-12 xl:h-20 xl:w-20 mx-2" /> 
                </button>
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={tailwindimg} alt="tailwind" className="h-12 w-12 xl:h-18 xl:w-20 mx-4" /> 
                </button>
                <button className="hover:bg-white rounded-xl hover:bg-opacity-20">
                    <img src={typescriptimg} alt="ts" className="h-12 w-12 xl:h-20 xl:w-20 mx-2" /> 
                </button>
            </div>
            </motion.div>
        </div>
