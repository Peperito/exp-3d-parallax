...
export const NavBar = () => {
    return (
        <div className="flex flex-row top-0 w-screen h-20 bg-indigo-900 items-center justify-between">
            <h2 className="scale-50  xl:scale-100 ml-8 font-semibold text-2xl md:text-3xl 2xl:text-4xl text-center text-transparent bg-gradient-to-r from-purple-400 to-orange-600 bg-clip-text">
